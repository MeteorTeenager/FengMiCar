		...
		<div class="navBar layui-side-scroll" id="navBar">
			<ul class="layui-nav layui-nav-tree">
				...
				<li class="layui-nav-item">
					...
					<dl class="layui-nav-child">
						<dd>
							<a data-url="../rent/toRentCarManager.action">
								<i class="layui-icon" data-icon="">
									<cite>汽车出租</cite>
								</i>
							</a>
						...
						<dd>
							<a data-url="../rent/toRentManager.action">
								<i class="layui-icon" data-icon="">
									<cite>出租单管理</cite>
								</i>
							</a>
						...
						<dd>
							<a data-url="../check/toCheckCarManager.action">
								<i class="layui-icon" data-icon="">
									<cite>汽车入库</cite>
								</i>
							</a>
						...
						<dd>
							<a data-url="../check/toCheckManager.action">
								<i class="layui-icon" data-icon="">
									<cite>检查单管理</cite>
								</i>
							</a>
